...
def generate_economic_report(economic_indicators, income_statement_text, balance_sheet_text, cash_flow_statement_text):
    user_message_content = f"Generate a structured and comprehensive due-diligence report suitable for finance professionals (at least 2000 words), for the following company, following this provided format:\n\n" \
        ...
        "4. Market and Competitor Analysis (600 words): Analyze the company's market share, competitive landscape, and industry trends. Assess how the company is positioned relative to its competitors and how broader economic indicators like sector performance at " + f"{economic_indicators['Sector Performance']}" + " and consumer confidence at " + f"{economic_indicators['Consumer Confidence']}" + " may influence the market landscape. Identify key competitors, market trends, potential barriers to entry, and growth opportunities. Discuss the company's competitive advantages and ability to maintain or expand its market position. \n" \
        "5. Risk Assessment (600 words): Identify and evaluate potential risks, including market risks, operational risks, legal risks, and financial risks. Discuss how external economic factors, such as changes in the Manufacturing PMI at " + f"{economic_indicators['Manufacturing PMI']}" + " or unemployment rates at " + f"{economic_indicators['Unemployment Rate']}%" + ", could impact these risk factors.  Include an analysis of risk mitigation strategies the company employs and their effectiveness. Highlight specific risks related to supply chain disruptions, technological changes, regulatory changes, and market volatility.\n" \
        "6. Legal and Compliance Review (300 words): Overview of the company's legal standings, regulatory compliance issues, and any ongoing litigations. Consider the impact of economic policies and regulations on compliance requirements, reflecting on how changes in economic indicators influence legal landscapes. Highlight any significant legal challenges the company has faced or is currently facing and their potential implications. Discuss the company's compliance with industry standards, data protection regulations, and environmental laws. \n" \
        "7. Management and Governance (300 words): Analyze the company's leadership, corporate governance practices, and any noteworthy executive decisions or changes. Reflect on how economic trends could influence management strategies and governance practices, considering the broader economic indicators provided. Evaluate the effectiveness of the board of directors, the experience of the executive team, and any recent management changes. Discuss the company's corporate governance policies, ethical standards, and transparency in operations. \n\n" \
        ...
        "This information will provide a backdrop for understanding the company's financial health, market position, and potential risks, offering a holistic view of its current status and future prospects."
...
if __name__ == '__main__':
    ...
    income_statement_text = input("Enter the income statement data: ")
    balance_sheet_text = input("Enter the balance sheet data: ")
    cash_flow_statement_text = input("Enter the cash flow statement data: ")

    generate_economic_report(economic_indicators, income_statement_text, balance_sheet_text, cash_flow_statement_text)
